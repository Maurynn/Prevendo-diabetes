...
def generate_explanation(graph_type):
    prompt = f"Explique em até 600 caracteres, de forma objetiva e respeitando os parágrafos o gráfico de distribuições {graph_type}."
    try:
